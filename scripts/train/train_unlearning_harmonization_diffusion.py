...
from src.pet_harmonization.diffusion import UnlearningHarmonizationDiffusionPipeline
...
from src.pet_harmonization.scheduler import GaussianNoiseScheduler
...
def main(args):
    ...
    if args.resume_checkpoint:
        ...
        diffuser = UnlearningHarmonizationDiffusionPipeline(
            feature_extractor=feature_extractor,
            domain_classifier=domain_classifier,
            noise_estimator=denoiser,
            noise_scheduler=noise_scheduler,
