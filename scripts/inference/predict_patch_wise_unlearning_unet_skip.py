...
from src.pet_harmonization.models.unet_v2_skip import UnlearningUNet, SpectralUNetWithIntermediateFeatures
        ...
        for z in z_starts:
            for y in y_starts:
                for x in x_starts:
                    ...
                    patch_pred = model.model.forward(patch_norm, t=None)
