...
def determine_modality(filename):
    ...
    if name_lower.lower().startswith('pet'):
        return 'pet'
    elif name_lower.lower().startswith('harmonized-pet'):
        return filename.split('.')[0] 
    elif 'pseudo-earl1' in name_lower.lower():
        return 'pseudo-earl1'
    elif 'pseudo-earl2' in name_lower.lower():
        return 'pseudo-earl2'
    elif 'gaussian-earl1' in name_lower.lower():
        return 'gaussian-earl1'
    elif 'gaussian-earl2' in name_lower.lower():
        return 'gaussian-earl2'
    elif 'earl1' in name_lower.lower():
        return 'earl1'
    elif 'earl2' in name_lower.lower():
        return 'earl2'
    elif 'earl' in name_lower.lower():
        return 'earl1'
